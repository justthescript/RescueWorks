...
def publish_pet_to_petfinder(db: Session, pet: models.Pet, settings: models.OrganizationSettings):
...
def remove_pet_from_petfinder(db: Session, pet: models.Pet, settings: models.OrganizationSettings):
